...
import com.educaweb.projetohibernatespring.entities.*;
import com.educaweb.projetohibernatespring.entities.enuns.OrderStatus;
import com.educaweb.projetohibernatespring.repositories.*;
...
public class TesteConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        p2.getCategories().addAll(Arrays.asList(cat, cat3));
